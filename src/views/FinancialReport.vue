  ...
  <div>
    ...
    <v-card class="mb-4">
      ...
      <v-card-text>
        <v-row class="ga-2" align="center">
          ...
          <v-col cols="12" sm="3">
            <v-btn color="teal" prepend-icon="mdi-magnify" @click="loadAll" :loading="loading">Consultar</v-btn>
          </v-col>
        </v-row>
      </v-card-text>
    </v-card>
    ...
    <v-card>
      <v-card-title class="d-flex align-center">
        ...
        <v-spacer></v-spacer>
        <v-btn size="small" variant="tonal" color="teal" prepend-icon="mdi-refresh" @click="loadCashFlow" :loading="loadingCashFlow">Actualizar</v-btn>
      </v-card-title>
